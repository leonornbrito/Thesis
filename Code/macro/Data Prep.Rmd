...
filtered_land_use <- filtered_land_use %>%
  select(-c(Item.Code, Item, Element.Code, Element))
...
# Assuming your dataset is named crop_nutrient_balance
filtered_crop_nutrient_balance <- crop_nutrient_balance %>%
  filter((Item == "Input" & Element %in% c("Cropland nitrogen", "Cropland phosphorus", "Cropland potassium")) |
    (Item == "Outputs" & Element %in% c("Cropland nitrogen", "Cropland phosphorus", "Cropland potassium"))|
    (Item == "Nutrient balance" & Element %in% c("Cropland nitrogen", "Cropland phosphorus", "Cropland potassium",
